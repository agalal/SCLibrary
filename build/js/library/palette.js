...
function updateColorPalette(){
  ...
  if(color_palette !== null){
    ...
    if(color_palette.Vibrant !== null){
      ...
      var vibrantRgbString = 'rgba('+vibrant.rgb[0]+','+vibrant.rgb[1]+','+vibrant.rgb[2]+','+0.4+')';
    ...
    if(color_palette.DarkVibrant !== null){
      ...
      var darkVibrantRgbString = 'rgba('+darkVibrant.rgb[0]+','+darkVibrant.rgb[1]+','+darkVibrant.rgb[2]+','+0.4+')';
